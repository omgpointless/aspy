...
impl Theme {
    ...
    pub fn by_name(name: &str) -> Self {
        match name.to_lowercase().as_str() {
            "basic" => Self::basic(),
            "terminal" | "auto" => Self::terminal(), // auto is legacy alias
            "dracula" => Self::dracula(),
            "monokai" => Self::monokai(),
            "monokai-pro-gogh" => Self::monokai_pro_gogh(),
            "nord" => Self::nord(),
            "gruvbox" => Self::gruvbox(),
            _ => Self::basic(), // default fallback
        }
    }

    /// Basic theme - clean RGB colors for consistent appearance across terminals
    /// Inspired by One Dark color palette
    pub fn basic() -> Self {
        Self {
            ...
            panel_logs: Color::Rgb(0x98, 0xc3, 0x79),   // green
            panel_detail: Color::Rgb(0xe5, 0xc0, 0x7b), // yellow
        }
    }

    /// Terminal theme - uses ANSI palette, adapts to your terminal's color scheme
    /// Use this if you want anthropic-spy to match your terminal's look
    pub fn terminal() -> Self {
        Self {
            ...
            // Muted fills - still RGB since ANSI doesn't have muted variants
            context_bar_fill: Color::Rgb(0x00, 0x64, 0x00),
            context_bar_warn: Color::Rgb(0x80, 0x80, 0x00),
            context_bar_danger: Color::Rgb(0x8b, 0x00, 0x00),
    ...
    pub fn dracula() -> Self {
        Self {
            ...
            panel_logs: Color::Rgb(0x50, 0xfa, 0x7b),   // green
    ...
    pub fn monokai() -> Self {
        Self {
            ...
            panel_logs: Color::Rgb(0xa6, 0xe2, 0x2e),   // green
    ...
    pub fn monokai_pro_gogh() -> Self {
        Self {
            ...
            panel_logs: Color::Rgb(0xa9, 0xdc, 0x76),   // green
    ...
    pub fn nord() -> Self {
        Self {
            ...
            panel_logs: Color::Rgb(0xa3, 0xbe, 0x8c),   // aurora green
    ...
    pub fn gruvbox() -> Self {
        Self {
            ...
            panel_logs: Color::Rgb(0xb8, 0xbb, 0x26),   // green
